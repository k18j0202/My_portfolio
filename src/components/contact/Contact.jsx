...
const Contact = () => {
    ...
    const formRef = useRef(); //email config from EmailJS
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_vnq9j54', 'template_e0hf1rk', formRef.current, {
            publicKey: 'vHBZUBm3b4hWVAmqi',
          })
          .then(
            (result) => {
              setSuccess(true)
    ...
    whileInView="animate">
        <motion.div className="textContainer">
            ...
            <motion.div className="item">
                <h2>Mail</h2>
                <span>ratchagankarthik623@gmail.com</span>
            </motion.div>
            <motion.div className="item">
                <h2>Address</h2>
                <span>No 36, GV Nagar, Alankuppam, Puducherry-605 111</span>
            </motion.div>
            <motion.div className="item">
                <h2>Phone</h2>
                <span>+91 8300457501</span>
            </motion.div>
        </motion.div>
        <div className="formContainer">
            ...
            <motion.svg fill="none" height="450px" width="450px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 512 512" xml:space="preserve">
            ...
            transition={{delay:4, duration:1}}>
                ...
                <input type="text" required placeholder="Email" name="from_email"/>
